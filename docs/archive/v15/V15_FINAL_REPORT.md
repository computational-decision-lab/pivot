...
Blockers: baseline snapshot, confirmatory mini-SWE transition audit, confirmatory promotion replay and closed loop, confirmatory Pi replication, confirmatory strategic response and registered ablations
