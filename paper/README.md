...
The release audit returns `READY_WITH_MINOR_MANUAL_CHECKS` when the local PDF, figure,
...
For a paper-only rebuild, `./build.sh` remains available; the unified release
audit command should be used before release so all audits and the supplement are
