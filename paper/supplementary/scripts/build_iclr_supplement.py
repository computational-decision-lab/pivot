...
PRIVATE_RE = re.compile(r"(?:<local-root>|<local-root>|<local-root>(?:/[A-Za-z0-9_.-]*)?)")
EMAIL_RE = re.compile(r"[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}")
ASSISTANT_RE = re.compile(r"implementation_assistant", flags=re.IGNORECASE)
...
def main() -> None:
    ...
    manifest = {
        ...
        + ["paper/snapshot", "paper/tables", "paper/results_macros.tex"],
    }
