...
% Shared scientific-figure-suite tokens: Okabe-Ito semantic palette.
\definecolor{pblue}{HTML}{0072B2}
\definecolor{pteal}{HTML}{009E73}
\definecolor{porange}{HTML}{D55E00}
\definecolor{ppurple}{HTML}{CC79A7}
\definecolor{pgray}{HTML}{6B7280}
\definecolor{plight}{HTML}{F4F6F8}
...
% The main figure contains the decision-critical path; world-layer taxonomy
% and reporting definitions are documented in the appendix.
