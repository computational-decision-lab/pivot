...
def build(root: Path) -> Path:
    ...
    lines = [
        "% Generated by scripts/build_paper_snippets.py; do not edit by hand.",
    ...
    output = root / "paper/v10_results_macros.tex"
    output.write_text("\n".join(lines) + "\n", encoding="utf-8")
    return output


def main() -> None:
    parser = argparse.ArgumentParser(description="Build semantic paper macros")
